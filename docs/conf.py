...
project = u'cakephp-queuesadilla'
project_pretty_name = u'CakePHP Queuesadilla'
copyright = u'%d, Jose Diaz-Gonzalez' % datetime.datetime.now().year
version = '1.0.0'
release = '1.0.0'
html_title = 'CakePHP Queuesadilla'
html_context = {
...
htmlhelp_basename = 'cakephp-queuesadilla'
latex_documents = [
    ('index', 'cakephp-queuesadilla.tex', u'cakephp-queuesadilla',
     u'Jose Diaz-Gonzalez', 'manual'),
]
man_pages = [
    ('index', 'cakephp-queuesadilla', u'CakePHP Queuesadilla Documentation',
     [u'Jose Diaz-Gonzalez'], 1)
]

texinfo_documents = [
    ('index', 'cakephp-queuesadilla', u'CakePHP Queuesadilla Documentation',
     u'Jose Diaz-Gonzalez', 'cakephp-queuesadilla', 'Easily run background jobs on various message backends',
     'Miscellaneous'),
]
